...
public class StepView extends LinearLayout {
    ...
    private void init(AttributeSet attrs, Context context) {
        if (attrs != null) {
            ...
            separatorColor = a.getColor(R.styleable.stepView_separatorColor,
                    ContextCompat.getColor(context, R.color.colorPrimary));
            separatorHeight = a.getInteger(R.styleable.stepView_separatorHeight, 60);
            separatorWidth = a.getInteger(R.styleable.stepView_separatorWidth, 3);
