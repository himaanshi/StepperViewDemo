...
public class SharedPreferencesUtils {
    ...
    private static SharedPreferencesUtils mSharedPreferenceUtils;
    ...
    /**
     * Creates single instance of SharedPreferencesUtils
     *
     * @param context context of Activity or Service
     * @return Returns instance of SharedPreferencesUtils
     */
    public static SharedPreferencesUtils getInstance(Context context) {

        if (mSharedPreferenceUtils == null) {
            mSharedPreferenceUtils = new SharedPreferencesUtils(context.getApplicationContext());
        }
